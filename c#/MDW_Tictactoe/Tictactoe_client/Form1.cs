...
namespace Tictactoe_client
{
    public partial class Form1 : Form, ServiceReference1.ITictactoeCallback
    {
        ...
        SoundPlayer sound = new SoundPlayer(@"c:\users\vanku\desktop\blop.wav");
        SoundPlayer loss = new SoundPlayer(@"E:\Downloads\Sad_Trombone-Joe_Lamb-665429450.wav");
        SoundPlayer win = new SoundPlayer(@"C:\Users\Vanku\Desktop\win.wav");
        bool turn = true;
        int wins = 0;
        ...
        public Form1()
        {
            ...
            proxy.FireJoinGameEvent(LoginForm.username);
            proxy.SubscribeToGame();

            proxy.AddPlayerToList(LoginForm.username);
            label1.Text = "your name is: " + LoginForm.username;
            label2.Text = "your opponents name is: " + proxy.GetName(LoginForm.username);
       ...
       public void onLoggingIn(string username)
       {
          //todo
       }
      ...
      /* public void WinsCallBack(string username, int wins)
       {
           label3.Text = username + " has " + wins + " wins";
       }*/
       ...
       public void OnMoveCallback(int buttonId, string XO)
       {
           ...
           if (checkwinner == 1)
           {
               ...
               MessageBox.Show("You have a LOSER");
               //this.WinsCallBack(LoginForm.username, wins);
               //label4.Text = this.WinsCallBack(proxy.GetName(LoginForm.username), wins);
               this.ResetBoard();
           }
