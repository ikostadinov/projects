...
function optionsframework_page() {
    ...
    <div id="optionsframework" class="postbox">
        ...
        <div id="optionsframework-submit">
            ...
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!' , 'office' ) ); ?>' );" />
            <div class="clear"></div>
			
	 <div id="go_pro">
            <h1>Go for Pro Version!</h1>
            <p>This is a free version of office. Get your own copy of professional version if you need to setup your theme with Unlimited homepage Slides , Full width page template, Forum support and much more. <a href="http://antthemes.com/?page_id=2219" target="blank">Click Here to Learn More Now</a> </p>
